...
MYSQL_PIDFILE=/opt/drupal-7.56-3/mysql/data/mysqld.pid

MYSQL_START="/opt/drupal-7.56-3/mysql/bin/mysqld_safe --defaults-file=/opt/drupal-7.56-3/mysql/my.cnf --mysqld=mysqld.bin --socket=/opt/drupal-7.56-3/mysql/tmp/mysql.sock  --datadir=/opt/drupal-7.56-3/mysql/data --log-error=/opt/drupal-7.56-3/mysql/data/mysqld.log  --pid-file=$MYSQL_PIDFILE --lower-case-table-names=1 "
