...
HTTPD_PIDFILE=/opt/drupal-7.56-3/apache2/logs/httpd.pid



HTTPD="/opt/drupal-7.56-3/apache2/bin/httpd -f /opt/drupal-7.56-3/apache2/conf/httpd.conf"
if [ -f "/opt/drupal-7.56-3/apps/bitnami/banner/disable-banner" ] ; then
...
. /opt/drupal-7.56-3/apache2/bin/envvars
